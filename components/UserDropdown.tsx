...
const UserDropdown = () => {
    ...
    const user = { name : "Nadiya", email : "nadiya-betuuu@gmail.com"};
            ...
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-3 text-gray-4 hover:text-yellow-500">
                    <Avatar className="h-8 w-8">
                        {/*<AvatarImage src="https://thumbs.dreamstime.com/b/awesome-knight-logo-vector-illustration-design-ready-to-use-144418705.jpg" className="object w-14 h-8 scale-125"/>*/}
